...
- All 27 active fixtures can estimate every supported campus. `listing-021`, **Affordable Scarborough Basement**, has no stored commute estimates and exercises the coordinate-derived fallback from its representative location.
